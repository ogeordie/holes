...
#### Table 2
This table shows the maximum difference in success rates across all algorithms and
each number of holes, for each site ratio considered in Figures 3. It is generated by
